    ...
    <div class="slide-one-item home-slider owl-carousel">
        ...
        <div class="site-blocks-cover" style="background-image: url(<?= SITE_DIR ?>upload/hero_bg_1.jpg);"
            ...
            <div class="text">
                ...
                <p class="mb-0">
                    <a href="#" class="text-uppercase small letter-spacing-1 font-weight-bold">
                        More Details
                    </a>
                </p>
        ...
        <div class="site-blocks-cover" style="background-image: url(<?= SITE_DIR ?>upload/hero_bg_3.jpg);"
             data-aos="fade" data-stellar-background-ratio="0.5">
