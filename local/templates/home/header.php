...
<div class="site-wrap">
    ...
    <? if ($APPLICATION->GetCurPage(false) !== "/"):    // выводим везде, кроме главной ?>
        <div class="site-blocks-cover inner-page-cover overlay"
             style="background-image: url(<?= SITE_DIR ?>upload/hero_bg_2.jpg);"
             data-aos="fade" data-stellar-background-ratio="0.5">
            <div class="container">
                <div class="row align-items-center justify-content-center text-center">
                    <div class="col-md-10">
                        <h1 class="mb-2">
                            <? $APPLICATION->ShowTitle(false)   // выводить заголовок страницы ?>
                        </h1>
