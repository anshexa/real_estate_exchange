    ...
    <nav class="menu-block">
        <ul>
            <li class="att popup-wrap">
                <a id="hd_singin_but_open" href="" class="btn-toggle">
                    <?= GetMessage("AUTH_LOGIN_LINK_TEXT") ?>
                </a>
                <form class="frm-login popup-block" name="system_auth_form<?= $arResult["RND"] ?>"
                    ...
                    <div class="frm-row">
                        <a href="<?= SITE_DIR ?>login/?forgot_password=yes" class="btn-forgot">
            ...
            <li>
                <a href="<?= SITE_DIR ?>login/?register=yes"><?= GetMessage("AUTH_REGISTER") ?>
                </a>
            </li>
        </ul>
    </nav>
<? else: ?>
    <? // информации для авторизованного пользователя ?>
